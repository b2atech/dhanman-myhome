-- FUNCTION: public.get_all_visitors_by_apartment(uuid)

-- DROP FUNCTION IF EXISTS public.get_all_visitors_by_apartment(uuid);

CREATE OR REPLACE FUNCTION public.get_all_visitors_by_apartment(
	p_apartment_id uuid)
...
ALTER FUNCTION public.get_all_visitors_by_apartment(uuid)
    OWNER TO dhanmanqa;
