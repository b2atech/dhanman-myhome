-- FUNCTION: public.get_visitor_approval_info_by_approval_id(integer)

-- DROP FUNCTION IF EXISTS public.get_visitor_approval_info_by_approval_id(integer);

CREATE OR REPLACE FUNCTION public.get_visitor_approval_info_by_approval_id(
	approval_id integer)
...
ALTER FUNCTION public.get_visitor_approval_info_by_approval_id(integer)
    OWNER TO devdhanman;