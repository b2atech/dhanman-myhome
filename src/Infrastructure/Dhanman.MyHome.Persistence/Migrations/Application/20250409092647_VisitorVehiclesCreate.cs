...
{
    /// <inheritdoc />
    public partial class VisitorVehiclesCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "visitor_vehicles",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    visitor_log_id = table.Column<int>(type: "integer", nullable: false),
                    visitor_number = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_visitor_vehicles", x => x.id);
                });
        }
