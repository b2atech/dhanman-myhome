...
namespace Dhanman.MyHome.Persistence.Migrations.Application
{
    ...
    [Migration("20230805144958_authentication")]
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Authorization.UserPaidModules", b =>
                {
                    ...
                    b.HasKey("UserId")
                        .HasName("pk_user_to_paid_modules_mapping");

                    b.ToTable("UserToPaidModulesMapping", (string)null);
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Authorization.UserRole", b =>
                {
                    ...
                    b.HasKey("UserId", "RoleName")
                        .HasName("pk_user_to_role_mapping");

                    b.ToTable("UserToRoleMapping", (string)null);
                });
