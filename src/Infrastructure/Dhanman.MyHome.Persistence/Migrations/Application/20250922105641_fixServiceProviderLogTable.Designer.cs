...
namespace Dhanman.MyHome.Persistence.Migrations
{
    ...
    [Migration("20250922105641_fixServiceProviderLogTable")]
    partial class fixServiceProviderLogTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dhanman.MyHome.Application.Contracts.Residents.ResidentNames", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_resident_name");

                    b.ToTable("resident_name", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Dhanman.MyHome.Application.Contracts.VisitorApprovals.VisitorNotificationDataDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.PrimitiveCollection<List<string>>("FcmTokens")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("fcm_tokens");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_visitor_notification_data_dto");

                    b.ToTable("visitor_notification_data_dto", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Portfolios.PortfolioDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_portfolio_dto");

                    b.ToTable("portfolio_dto", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Roles.RoleDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Units.UnitInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_unit_info");

                    b.ToTable("unit_info", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Units.UnitNamesByAparmentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("BuildingName")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "building_name");

                    b.Property<string>("FloorName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("floor_name")
                        .HasAnnotation("Relational:JsonPropertyName", "floor_name");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_unit_names_by_aparment_entity");

                    b.ToTable("unit_names_by_aparment_entity", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Units.UnitOwnerNameEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("OwnerFirstName")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "owner_first_name");

                    b.Property<string>("OwnerLastName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("owner_last_name")
                        .HasAnnotation("Relational:JsonPropertyName", "owner_last_name");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_unit_owner_name_entity");

                    b.ToTable("unit_owner_name_entity", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.UserFcmTokens.UserFcmToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Vehicals.VehicleInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_vehicle_info");

                    b.ToTable("vehicle_info", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.VisitorApprovals.UpdateVisitorStatusDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ApprovedVisitsCount")
                        .HasColumnType("integer")
                        .HasColumnName("approved_visits_count");

                    b.Property<int>("FinalStatusId")
                        .HasColumnType("integer")
                        .HasColumnName("final_status_id");

                    b.Property<int>("TotalVisitsCount")
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_update_visitor_status_dto");

                    b.ToTable("update_visitor_status_dto", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Visitors.VisitorByContactDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_visitor_by_contact_dto");

                    b.ToTable("visitor_by_contact_dto", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.Visitors.VisitorUserIdsDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.PrimitiveCollection<string[]>("FcmTokens")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("fcm_tokens");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_visitor_user_ids_dto");

                    b.ToTable("visitor_user_ids_dto", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Dhanman.MyHome.Domain.Entities.WaterTankerDeliveries.WaterTankerDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ActualReceivedLiters")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TankerCapacityLiters")
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_water_tanker_deliveries");

                    b.ToTable("water_tanker_deliveries", (string)null);
                });
