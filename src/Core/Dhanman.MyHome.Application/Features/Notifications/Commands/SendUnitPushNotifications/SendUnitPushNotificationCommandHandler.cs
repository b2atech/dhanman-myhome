...
//public class SendUnitPushNotificationCommandHandler : ICommandHandler<SendUnitPushNotificationCommand, Result<object>>
//{
//    private readonly IApplicationDbContext _dbContext;
//    private readonly IFirebaseService _fcm;
...
//        if (!residentIds.Any())
//        {
//            return Result.Failure<object>(Errors.General.EntityNotFound);
