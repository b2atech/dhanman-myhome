...
namespace Dhanman.MyHome.Domain.Entities.Apartments
{
    public class ServiceProviderLog : EntityInt, IAuditableEntity, ISoftDeletableEntity
    {
        ...
        #region Constructor
        public ServiceProviderLog(int serviceProviderId, int visitingUnitId, int? visitPurposeId, string visitingFrom, int currentStatusId, DateTime entryTime, DateTime? exitTime, Guid createdBy)
        {
