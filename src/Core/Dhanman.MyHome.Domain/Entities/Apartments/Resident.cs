...
{
    public class ResidentRequest : Entity, IAuditableEntity, ISoftDeletableEntity
    {
        #region Properties
        ...
        #region Constructor
        public ResidentRequest(Guid apartmentId, int buildingId, int floorId, int unitId, string firstName, string lastName, string email, string contactNumber, string? permanentAddressId, int requestStatusId, string residentTypeId, string occupancyStatusId, Guid createdBy)
        {
